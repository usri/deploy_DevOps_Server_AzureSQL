...
$akv_Content = (Invoke-WebRequest -Uri 'https://jaiakv1.vault.usgovcloudapi.net/secrets/AzDevOps2019SqlPass?api-version=2016-10-01' -UseBasicParsing -Method GET -Headers @{Authorization="Bearer $KeyVaultToken"}).content
